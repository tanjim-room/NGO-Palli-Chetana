...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('volunteers.add') }}" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <a href="{{ route('volunteers.delete',$item->id) }}" class="btn btn-sm btn-danger text-white text-center" data-confirm="Are you sure you want to delete this volunteer?">
